"""
Author: Jeimilitza Sainz Lopez, Orlado Lopez De Victoria Velez
Chess Knight and King move and Diagonal constraint Sudoku
"""
import pygame
...
kVal = 9
# Getting random values that will be used for the initial values
